      ...
      {multiRunPage === 1 && (
        <div className="chart-container">
          ...
          <div className="test-results">
            ...
            <div className="test-card"><h4>{t('multiRun.nistMonobitFrequency')}</h4><p className={analysis.test_results.frequency_test_passed_count > 0 ? 'pass' : 'fail'}>{t('multiRun.runsPassedP01', { n: analysis.test_results.frequency_test_passed })}</p></div>
            <div className="test-card"><h4>{t('multiRun.nistFrequencyWithinBlock')}</h4><p className={analysis.test_results.frequency_within_block_test_passed_count > 0 ? 'pass' : 'fail'}>{t('multiRun.runsPassedP01', { n: analysis.test_results.frequency_within_block_test_passed })}</p></div>
            <div className="test-card"><h4>{t('multiRun.nistCumulativeSums')}</h4><p className={analysis.test_results.cumulative_sums_test_passed_count > 0 ? 'pass' : 'fail'}>{t('multiRun.runsPassedP01', { n: analysis.test_results.cumulative_sums_test_passed })}</p></div>
            <div className="test-card"><h4>{t('multiRun.nistSpectralTest')}</h4><p className={analysis.test_results.spectral_test_passed_count > 0 ? 'pass' : 'fail'}>{t('multiRun.runsPassedP01', { n: analysis.test_results.spectral_test_passed })}</p></div>
